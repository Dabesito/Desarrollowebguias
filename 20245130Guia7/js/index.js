...
const imprimir = document.getElementById("idImprimirResultado"); // Esta variable se declara pero no se usa en las funciones mostradas.
...
const contarElementos = function (elemento) {
    ...
    console.log(
        `Etiquetas buscadas <${elemento}> y </${elemento}> / Total encontradas : ${arrayElement.length}`
    );
